...
@interface PhongShaderViewController ()

@end

@implementation PhongShaderViewController
...
- (void)compileShaders {
    ...
    self.simpleProgram = [[OGLProgram alloc] initWithVertexShader:@"PhongVertex" fragmentShader:@"PhongFragment"];    
